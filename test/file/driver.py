...
from mondoo.mdo.engine.manager.driver          import FileManager


if __name__ == '__main__':
    @with_duration_banner("Test available methods")
    def test_avail_methods():
        methods = FileManager.get_available_methods('pdf')
        print(f"Available methods of pdf: {methods}")
        
        methods = FileManager.get_available_methods('docx')
        print(f"Available methods of docx: {methods}")
        
        methods = FileManager.get_available_methods('png')
        print(f"Available methods of png: {methods}")
        
        methods = FileManager.get_available_methods('jpg')
    ...
    def test_open():    
        ...
        for obj in objs:
            FileManager.dump(obj)
            FileManager.export(obj)
